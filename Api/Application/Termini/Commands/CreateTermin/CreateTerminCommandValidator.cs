...
namespace SportskiCentarRS2.Application.Termini.Commands.CreateTermin
{
    public class CreateTerminCommandValidator : AbstractValidator<CreateTerminCommand>
    {
        ...
        public CreateTerminCommandValidator(IApplicationDbContext context)
        {
            _context = context;
            RuleFor(x => x.Pocetak)
        ...
        public async Task<bool> ProstorijaSlobodna(CreateTerminCommand command, DateTime pocetak,CancellationToken cancellationToken)
        {
