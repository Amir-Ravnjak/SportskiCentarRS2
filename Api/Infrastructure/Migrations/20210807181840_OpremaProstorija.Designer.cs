...
namespace SportskiCentarRS2.Infrastructure.Migrations
{
    ...
    [Migration("20210807181840_OpremaProstorija")]
    partial class OpremaProstorija
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpremaProstorija", b =>
                {
                    b.Property<int>("OpremaId")
                        .HasColumnType("int");

                    b.Property<int>("ProstorijeId")
                        .HasColumnType("int");

                    b.HasKey("OpremaId", "ProstorijeId");

                    b.HasIndex("ProstorijeId");

                    b.ToTable("OpremaProstorija");
                });
            ...
            modelBuilder.Entity("OpremaProstorija", b =>
                {
                    b.HasOne("SportskiCentarRS2.Domain.Entities.Oprema", null)
                        .WithMany()
                        .HasForeignKey("OpremaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SportskiCentarRS2.Domain.Entities.Prostorija", null)
                        .WithMany()
                        .HasForeignKey("ProstorijeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
